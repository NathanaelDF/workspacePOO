	...
	public void exibeMenu() {
		...
		do {// repitir até o usúario escolher o número 4 dentro do JComboBox declarada
			...
			case 1:// parte de movimentação das partes da casa (janelas e portas)
				...
				ArrayList<Aberturas> listaDeAberturas = new ArrayList<Aberturas>();// inicia a uma ArrayList de aberturas, uqe irá subistituir a antiga lista, tanto de porta ou janela
				...
				break;
			case 2:// ver as informações das casas
				if (this.casa == null) {
